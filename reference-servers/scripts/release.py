...
class GitHashParamType(click.ParamType):
    """
    GitHashParamType class that inherits from click.ParamType.
    ...
    Returns:
        GitHash | None: Description of return value
...
class Package(Protocol):
    """
    Package class that inherits from Protocol.
...
def find_changed_packages(directory: Path, git_hash: GitHash) -> Iterator[Package]:
    ...
    Args:
        ...
        git_hash: Description of git_hash
    
    Returns:
        Iterator[Package]: Description of return value
...
def generate_matrix(directory: Path, git_hash: GitHash, pypi: bool, npm: bool) -> int:
    ...
    Args:
        directory: Description of directory
        git_hash: Description of git_hash
        pypi: Description of pypi
        npm: Description of npm
