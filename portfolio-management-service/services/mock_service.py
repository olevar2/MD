...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/portfolios', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/positions', 'expected_status': 200}]:
...
print(f"Starting mock service for portfolio-management-service on port {PORT}")
