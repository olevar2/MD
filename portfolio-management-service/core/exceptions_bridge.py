...
3. Replace PortfolioManagementError with your service-specific error class
...
class PortfolioManagementValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class PortfolioManagementDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class PortfolioManagementBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = PortfolioManagementError,
...
__all__ = [
    ...
    "PortfolioManagementValidationError",
    "PortfolioManagementDataError",
    "PortfolioManagementBusinessError",
