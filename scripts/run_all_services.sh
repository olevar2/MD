...
# This script is a wrapper for run_all_services.py that handles environment setup and error handling
...
# Run the run_all_services.py script
run_all_services_script() {
    log "Starting all services for the Forex Trading Platform..."
    ...
    # Build command
    CMD="python3 $SCRIPT_DIR/run_all_services.py --env $ENV"
...
# Main function
main() {
    log "Starting Forex Trading Platform services..."
    ...
    success "Forex Trading Platform services started successfully"
}
