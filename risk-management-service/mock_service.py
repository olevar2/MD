...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/risk-profiles', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/risk-limits', 'expected_status': 200}]:
...
print(f"Starting mock service for risk-management-service on port {PORT}")
