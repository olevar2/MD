...
from trading_gateway_service.simulation.news_sentiment_simulator import NewsImpactLevel
...
class RiskRegimeDetector:
    ...
    def detect_regime(
        ...
        if news_events:
            high_impact_news = [e for e in news_events if e.get('impact') >= NewsImpactLevel.HIGH.value]
