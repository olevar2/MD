...
def apply_standardized_configuration():
    ...
    for service_dir in SERVICE_DIRS:
        ...
        results["files_created"].append(standardized_config_path)
        ...
        results["files_updated"].append(config_init_path)
        ...
        if not os.path.exists(env_file_path):
            ...
            results["files_created"].append(env_file_path)


    # Save results to file
    output_path = os.path.join(output_dir, 'standardized_configuration_results.json')
