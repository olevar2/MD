#!/usr/bin/env python3
"""
Start script for the Feature Store Service.
"""
...
def start_service():
    ...
    try:
        ...
        print("Feature Store Service is running on port 8005")
        print("Health endpoint: http://localhost:8005/health")
        print("API endpoints:")
        print("  - GET /api/v1/features")
        print("  - GET /api/v1/feature-sets")
