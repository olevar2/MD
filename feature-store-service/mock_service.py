...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/features', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/feature-sets', 'expected_status': 200}]:
...
print(f"Starting mock service for feature-store-service on port {PORT}")
