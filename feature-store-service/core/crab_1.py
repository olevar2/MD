"""
Crab Pattern Detector Module.

This module provides the CrabPatternDetector class for detecting Crab harmonic patterns.
"""
...
class CrabPatternDetector(BasePatternDetector):
    """
    Crab Pattern Detector.
    
    This class detects Crab harmonic patterns in price data.
    """
    ...
    def detect(self, data: pd.DataFrame, pivot_indices: pd.Index) -> pd.DataFrame:
        ...
        for i in range(len(pivot_indices) - 4):
            ...
            if matches_template:
                ...
                # For Crab pattern, target is often a 1.618 extension of the XA leg
