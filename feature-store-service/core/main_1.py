...
from core.enhanced_logging import configure_logging, get_logger
...
from core.error_manager import IndicatorError
from api.exception_handlers import forex_platform_exception_handler, indicator_error_handler, validation_exception_handler, sqlalchemy_exception_handler, data_validation_exception_handler, data_fetch_exception_handler, data_storage_exception_handler, data_transformation_exception_handler, service_exception_handler, general_exception_handler
from api.feature_computation_api import feature_computation_router
from api.indicator_api import indicator_router
from api.realtime_indicators_api import realtime_indicators_router
from core.incremental_indicators import router as incremental_indicators_router
...
from config.config_1 import CacheConfig
...
from core.indicator_manager import initialize_indicator_service
...
async def startup_event():
    ...
    try:
        ...
        from core.advanced_indicators_registrar import register_advanced_indicators
        ...
        from api.indicator_api import set_indicator_registry
