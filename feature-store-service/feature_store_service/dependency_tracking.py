...
class DependencyTracker:
    ...
    def __init__(self):
        ...
        self._dependencies: Dict[str, Set[str]] = {}  # indicator -> dependent indicators
        self._reverse_deps: Dict[str, Set[str]] = {}  # indicator -> prerequisites
    ...
    def _update_calculation_order(self) -> None:
        ...
        def visit(indicator: str) -> None:
            if indicator in temp:
                raise ValueError(f"Circular dependency detected involving {indicator}")
    ...
    def export_dependencies(self) -> Dict:
        ...
        return {
            ...
            "calculation_order": self._calculation_order,
            "last_updated": {
                k: v.isoformat() for k, v in self._last_updated.items()
            }
        }
