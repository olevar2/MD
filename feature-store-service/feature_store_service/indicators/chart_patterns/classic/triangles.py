...
This module provides functionality to detect triangle patterns (ascending, descending, symmetric)
in price data.
"""
...
class TrianglePattern(PatternRecognitionBase):
    """
    Triangle Pattern Detector.
    
    Identifies ascending, descending, and symmetric triangle patterns in price data.
    """
    ...
    def calculate(self, data: pd.DataFrame) -> pd.DataFrame:
        """
        Calculate triangle pattern recognition for the given data.
