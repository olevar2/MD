"""
Butterfly Pattern Detector Module.

This module provides the ButterflyPatternDetector class for detecting Butterfly harmonic patterns.
"""
...
class ButterflyPatternDetector(BasePatternDetector):
    """
    Butterfly Pattern Detector.
    
    This class detects Butterfly harmonic patterns in price data.
    """
