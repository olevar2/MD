"""
Bat Pattern Detector Module.

This module provides the BatPatternDetector class for detecting Bat harmonic patterns.
"""
...
class BatPatternDetector(BasePatternDetector):
    """
    Bat Pattern Detector.
    
    This class detects Bat harmonic patterns in price data.
    """
