...
from feature_store_service.main import feature_storage
            ...
            for param_name, param_info in metadata["parameters"].items():
                parameters.append(
                    ParameterInfo(
                        ...
                        default=str(param_info.get("default")) if param_info.get("default") is not None else None,
...
async def get_indicator_presets():
    ...
    """
    # These presets combine multiple indicators for specific trading styles
    presets = {
        "trend_following": {
            "name": "Trend Following",
            "description": "Indicators useful for trend following strategies",
            "indicators": [
                "sma", "ema", "macd", "adx"
            ]
        },
        "swing_trading": {
            "name": "Swing Trading",
            "description": "Indicators useful for swing trading strategies",
            "indicators": [
        ...
        "volatility_based": {
            ...
            "description": "Indicators focusing on market volatility",
            "indicators": [
                "atr", "bollinger_bands", "keltner_channels", "vix"
            ]
        },
        "mean_reversion": {
            "name": "Mean Reversion",
            "description": "Indicators useful for mean reversion strategies",
            "indicators": [
                "rsi", "bollinger_bands", "stochastic", "macd"
            ]
        },
        "volume_analysis": {
            "name": "Volume Analysis",
            "description": "Indicators focused on volume analysis",
            "indicators": [
                "obv", "mfi", "vwap", "volume"
            ]
        }
...
def set_indicator_registry(registry: IndicatorRegistry, indicator_service: Optional[EnhancedIndicatorService] = None):
    ...
    if indicator_service:
        ...
        logger.info("Enhanced indicator service with caching support is enabled")