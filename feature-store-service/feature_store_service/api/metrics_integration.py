"""
Metrics Integration for Feature Store Service.
...
from feature_store_service.monitoring.service_metrics import FeatureStoreMetrics

# Configure logging
logger = logging.getLogger(__name__)

def setup_metrics(app: FastAPI, service_name: str = "feature-store-service") -> None:
    """
