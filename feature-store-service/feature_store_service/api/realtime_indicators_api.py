...
# Create router
realtime_indicators_router = APIRouter(
    prefix="/api/realtime-indicators",
    tags=["realtime-indicators"],
    responses={404: {"description": "Not found"}},
)

# Global instance of the real-time processor
# In a production environment, this would be a singleton managed by a dependency injection framework
