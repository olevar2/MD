...
from feature_store_service.indicators.statistical_regression_indicators import StandardDeviationIndicator as StdDevIndicator, LinearRegressionIndicator as LinRegIndicator, LinearRegressionChannel as LinRegChannelIndicator, RSquaredIndicator as RSquaredIndicator
