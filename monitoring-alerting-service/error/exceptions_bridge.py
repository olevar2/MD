...
3. Replace MonitoringAlertingError with your service-specific error class
...
# Service name
SERVICE_NAME = "monitoring-alerting"  # Replace with your service name


# Service-specific error class
class MonitoringAlertingError(ServiceError):
...
class MonitoringAlertingValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class MonitoringAlertingDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class MonitoringAlertingBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = MonitoringAlertingError,
...
__all__ = [
    ...
    "MonitoringAlertingValidationError",
    "MonitoringAlertingDataError",
    "MonitoringAlertingBusinessError",
