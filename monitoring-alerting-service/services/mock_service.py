...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/alerts', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/metrics', 'expected_status': 200}]:
...
print(f"Starting mock service for monitoring-alerting-service on port {PORT}")
