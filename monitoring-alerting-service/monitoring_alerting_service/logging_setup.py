"""
Standardized Logging Setup Module for Monitoring Alerting Service
...
from monitoring_alerting_service.config.standardized_config import get_logging_config, settings

# Create logger
logger = logging.getLogger("monitoring_alerting_service")

def configure_logging(
    service_name: str = "monitoring_alerting_service",
...
configure_logging(
    service_name="monitoring_alerting_service",
