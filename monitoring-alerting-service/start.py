#!/usr/bin/env python3
"""
Start script for the Monitoring Alerting Service.
"""
...
def start_service():
    """Start the Monitoring Alerting Service."""
    ...
    try:
        ...
        print("Monitoring Alerting Service is running on port 8008")
        print("Health endpoint: http://localhost:8008/health")
        print("API endpoints:")
