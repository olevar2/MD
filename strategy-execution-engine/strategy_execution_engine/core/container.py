...
class ServiceContainer:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            # Example: self._services["database"] = await self._create_database_connection()
    ...
    async def shutdown(self) -> None:
        ...
        if not self._initialized:
            logger.warning("Service container not initialized, nothing to shut down")
            return
        ...
        try:
            ...
            # Example: await self._services["database"].close()
            
            self._initialized = False
            self._services.clear()
            logger.info("Service container shutdown successfully")
        except Exception as e:
            logger.error(f"Failed to shutdown service container: {e}", exc_info=True)
            raise
