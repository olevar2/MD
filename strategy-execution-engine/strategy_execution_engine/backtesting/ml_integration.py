...
from strategy_execution_engine.adapters.ml_prediction_adapter import MLPredictionServiceAdapter
...
class MLBacktesterIntegration:
    ...
    def __init__(self,
                ...
                ml_client: Optional[MLPredictionServiceAdapter] = None,
        ...
        self.ml_client = ml_client or MLPredictionServiceAdapter(config={"ml_integration_base_url": api_base_url})
    ...
    async def get_prediction(self,
        ...
        try:
            # Get prediction from ML service using the adapter
            prediction_result = await self.ml_client.get_prediction(
                model_id=model_name,
                inputs=inputs,
            ...
            result = {
                ...
                "version_id": prediction_result.version_id,
