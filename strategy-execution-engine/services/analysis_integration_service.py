...
import pandas as pd
from core.signal_aggregator import SignalAggregator, Signal, SignalDirection, SignalSource, SignalTimeframe
...
class AnalysisIntegrationService:
    ...
    async def _get_ml_predictions(self, symbol: str, timeframe:
        ...
        from adapters.ml_prediction_adapter import MLSignalGeneratorAdapter
        try:
