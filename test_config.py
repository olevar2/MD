...
def test_helper_functions():
    ...
    assert get_db_url() == "postgresql://test:test@localhost:5432/testdb", f"Expected 'postgresql://test:test@localhost:5432/testdb', got '{get_db_url()}'"
    assert get_redis_url() == "redis://localhost:6379/0", f"Expected 'redis://localhost:6379/0', got '{get_redis_url()}'"
    assert get_market_data_service_url() == "http://test-market-data:8001", f"Expected 'http://test-market-data:8001', got '{get_market_data_service_url()}'"
    assert get_notification_service_url() == "http://test-notification:8002", f"Expected 'http://test-notification:8002', got '{get_notification_service_url()}'"
