...
This module provides database connectivity for the service.
"""
...
from common_lib.templates.service_template.config import get_database_config
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            self.pool = await asyncpg.create_pool(
                ...
                min_size=getattr(self.config, "min_connections", None) or 1,
                max_size=getattr(self.config, "max_connections", None) or 10
            )
