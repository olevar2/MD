...
3. Replace ServiceSpecificError with your service-specific error class
...
# Service name
SERVICE_NAME = "service-template"  # Replace with your service name


# Service-specific error class
class ServiceSpecificError(ServiceError):
...
class ServiceSpecificValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class ServiceSpecificDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class ServiceSpecificBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = ServiceSpecificError,
...
__all__ = [
    ...
    "ServiceSpecificValidationError",
    "ServiceSpecificDataError",
    "ServiceSpecificBusinessError",
