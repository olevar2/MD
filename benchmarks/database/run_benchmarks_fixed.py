...
def setup_docker_environment():
    ...
    docker_compose_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "docker-compose.benchmark.yml")
...
def run_benchmark(benchmark, args):
    ...
    if args.use_mocks:
        ...
        enable_mocks_script = os.path.join(os.path.dirname(os.path.abspath(__file__)), "enable_mocks.py")
        subprocess.run([sys.executable, enable_mocks_script], check=True)
