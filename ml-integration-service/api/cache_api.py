...
from core.model_inference_cache import get_cache_stats, clear_model_cache
from core.feature_vector_cache import get_feature_cache_stats, clear_feature_cache
