...
3. Replace MLIntegrationError with your service-specific error class
...
# Service name
SERVICE_NAME = "ml-integration"  # Replace with your service name


# Service-specific error class
class MLIntegrationError(ServiceError):
...
class MLIntegrationValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class MLIntegrationDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class MLIntegrationBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = MLIntegrationError,
...
__all__ = [
    ...
    "MLIntegrationError",
    "MLIntegrationValidationError",
    "MLIntegrationDataError",
    "MLIntegrationBusinessError",
