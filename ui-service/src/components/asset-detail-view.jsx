...
import ForexDetails from './asset_detail/ForexDetails';
import CryptoDetails from './asset_detail/CryptoDetails';
import StockDetails from './asset_detail/StockDetails';
import CommodityDetails from './asset_detail/CommodityDetails';
import IndexDetails from './asset_detail/IndexDetails';
import DefaultDetails from './asset_detail/DefaultDetails';
...
const AssetDetailView = ({ symbol, timeframe }) => {
  ...
  return (
    <div className="asset_detail-container">
