...
3. Replace UIError with your service-specific error class
...
# Service name
SERVICE_NAME = "ui"  # Replace with your service name


# Service-specific error class
class UIError(ServiceError):
...
class UIDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class UIBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = UIError,
