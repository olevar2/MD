...
cp chat_interface_template/ChatBackendService.py ml-integration-service/ml_integration_service/chat/
...
```python
# ml-integration-service/ml_integration_service/chat/ChatBackendService.py
