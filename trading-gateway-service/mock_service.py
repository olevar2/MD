...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/instruments', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/accounts', 'expected_status': 200}]:
...
print(f"Starting mock service for trading-gateway-service on port {PORT}")
