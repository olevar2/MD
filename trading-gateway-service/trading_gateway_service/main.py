...
from trading_gateway_service.core.service_template import get_service_template
...
async def startup_event():
    ...
    """
                ...
                logger.info(
                    f"Adding external position: {position['instrument']}")
    ...
    """
                ...
                logger.info(
                    f'Updating position: {instrument} -> {size} {direction}')
