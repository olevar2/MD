"""
Metrics Integration for Trading Gateway Service.
...
from trading_gateway_service.monitoring.service_metrics import TradingGatewayMetrics

# Configure logging
logger = logging.getLogger(__name__)

def setup_metrics(app: FastAPI, service_name: str = "trading-gateway-service") -> None:
    """
