...
try:
    ...
    SB3_AVAILABLE = False
from trading_gateway_service.simulation.reinforcement_learning.curriculum_learning_framework import CurriculumLearningFramework, DifficultyLevel
from trading_gateway_service.simulation.reinforcement_learning.environment_generator import ForexTradingEnvironment, EnvConfiguration, EnvironmentGenerator, ActionType
from trading_gateway_service.simulation.reinforcement_learning.agent_benchmarking import RLAgentBenchmark, BenchmarkCategory
