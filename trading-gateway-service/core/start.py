#!/usr/bin/env python3
"""
Start script for the Trading Gateway Service.
"""
...
def start_service():
    """Start the Trading Gateway Service."""
    ...
    try:
        ...
        print("Trading Gateway Service is running on port 8001")
        print("Health endpoint: http://localhost:8001/health")
        print("API endpoints:")
        print("  - GET /api/v1/instruments")
