...
3. Replace TradingGatewayError with your service-specific error class
...
# Service name
SERVICE_NAME = "trading-gateway"  # Replace with your service name


# Service-specific error class
class TradingGatewayError(ServiceError):
...
class TradingGatewayValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class TradingGatewayDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class TradingGatewayBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = TradingGatewayError,
...
__all__ = [
    ...
    "TradingGatewayError",
    "TradingGatewayValidationError",
    "TradingGatewayDataError",
    "TradingGatewayBusinessError",
