#!/usr/bin/env python3
"""
IndicatorProviderAdapter - Adapter for IIndicatorProvider
"""

from typing import Dict, List, Optional, Any

from common_lib.interfaces import IIndicatorProvider
...
class IndicatorProviderAdapter(IIndicatorProvider):
    """
    Adapter implementation for IIndicatorProvider.
    """
