...
3. Replace AnalysisEngineError with your service-specific error class
...
# Service name
SERVICE_NAME = "analysis-engine"  # Replace with your service name


# Service-specific error class
class AnalysisEngineError(ServiceError):
...
class AnalysisEngineValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class AnalysisEngineDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class AnalysisEngineBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = AnalysisEngineError,
...
__all__ = [
    ...
    "AnalysisEngineError",
    "AnalysisEngineValidationError",
    "AnalysisEngineDataError",
    "AnalysisEngineBusinessError",
