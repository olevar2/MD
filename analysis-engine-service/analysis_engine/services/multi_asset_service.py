...
class MultiAssetService(IMultiAssetService):
    ...
    def get_correlated_symbols(self, symbol: str, threshold: float = 0.7) -> List[str]:
        ...
        correlated_assets = self.asset_registry.get_correlated_assets(symbol, threshold)
    ...
    def get_asset_info(self, symbol: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "trading_parameters": self.asset_registry.get_trading_parameters(symbol),
    ...
    def get_analysis_parameters(self, symbol: str) -> Dict[str, Any]:
        ...
        params = {
            "volatility_window": 14,  # Default ATR window
            "pip_value": asset.config.pip_value,
            "typical_spread": adapter.get_typical_spreads(symbol).get("typical", 0),
            "position_sizing_factors": adapter.get_position_sizing_factors(symbol)
        }
        ...
        if asset.asset_class == AssetClass.FOREX:
            ...
            params["default_stop_atr_multiple"] = 2.0  # Wider stops for crypto
            params["volatility_window"] = 20  # Longer window due to higher volatility
