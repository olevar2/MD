    ...
    news_items = [
        {
            ...
            "content": "The Federal Reserve announced today that it will raise interest rates by 25 basis points, citing concerns about inflation and strong economic growth. The move was widely expected by market participants.",
        ...
        },
        {
            ...
            "content": "The European Central Bank has signaled that it may cut interest rates in June, as inflation in the eurozone continues to moderate and economic growth remains sluggish.",
            "source": "Bloomberg",
...
async def analyze_economic_report_example():
    ...
    report = {
        ...
        "content": "The U.S. economy added 200,000 jobs in April 2025, exceeding expectations of 180,000. The unemployment rate remained steady at 3.8%. Average hourly earnings increased by 0.3% month-over-month, in line with expectations.",
        "type": "NFP",
...
async def get_combined_insights_example():
    ...
    # Currency pairs to filter for
    currency_pairs = ["EUR/USD", "GBP/USD"]
    
    try:
        # Get combined insights
        result = await client.get_combined_insights(
            news_data=news_data,
