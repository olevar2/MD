...
class MarketRegimeResult:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'MarketRegimeResult':
        ...
        return cls(
            ...
            regime=MarketRegimeType(data.get("regime", MarketRegimeType.UNKNOWN.value)),
            direction=TrendState(data.get("direction", TrendState.NEUTRAL.value)),
            volatility=VolatilityState(data.get("volatility", VolatilityState.UNKNOWN.value)),
...
class RegimeChangeResult:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'RegimeChangeResult':
        ...
        return cls(
            ...
            current_regime=MarketRegimeResult.from_dict(data.get("current_regime", {})),
            previous_regime=MarketRegimeResult.from_dict(data.get("previous_regime", {})),
