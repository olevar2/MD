...
class ChatNLPAnalyzer(BaseNLPAnalyzer):
    ...
    def process_message(
        ...
        # Recognize intent
        intent = self.intent_recognizer.recognize_intent(message, entities, user_context)
    ...
    def update_context(
        ...
        Returns:
            Updated context
        """
        return self.context_manager.update_context(user_id, message, intent, entities, response)
    ...
    def get_primary_intent(
        ...
        Returns:
            Primary intent name
        """
        intent_info = self.intent_recognizer.recognize_intent(message, entities, context)
    ...
    def get_entity_from_context(
        ...
        """
        return self.context_manager.get_entity_from_context(user_id, entity_type)
    ...
    def set_user_preference(
        ...
        """
        self.context_manager.set_user_preference(user_id, preference_key, preference_value)
    ...
    def get_user_preference(
        ...
        """
        return self.context_manager.get_user_preference(user_id, preference_key, default_value)
