...
from analysis_engine.resilience import (
    retry_with_policy, register_database_retryable_exceptions,
    timeout_handler, create_circuit_breaker
)
...
# Register common database exceptions for retry
...
class ResilientDatabaseManager:
    ...
    def __init__(self, settings: Settings = None):
        ...
        self.circuit_breaker = create_circuit_breaker(
            ...
            config=get_circuit_breaker_config("database")
        )
