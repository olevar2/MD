...
from analysis_engine.analysis.backtesting.core import (
    BacktestConfiguration, BacktestResult, DataSplit
)
from analysis_engine.analysis.backtesting.walk_forward import (
    WalkForwardOptimizationConfig, WalkForwardResult
)
from analysis_engine.analysis.backtesting.monte_carlo import (
    MonteCarloSimulationConfig, MonteCarloResult
)
from analysis_engine.analysis.backtesting.stress_testing import (
...
class StrategyConfig(BaseModel):
    ...
    position_sizing: Optional[Dict[str, Any]] = Field(None, description="Position sizing settings")
...
class BacktestRequest(BaseModel):
    ...
    commission_model: Optional[str] = Field("fixed", description="Commission model (fixed, percentage)")
    commission_settings: Optional[Dict[str, Any]] = Field(None, description="Commission settings")
    slippage_model: Optional[str] = Field("fixed", description="Slippage model (fixed, percentage, variable)")
    slippage_settings: Optional[Dict[str, Any]] = Field(None, description="Slippage settings")
    data_source: Optional[str] = Field("historical", description="Data source (historical, generated)")
    data_parameters: Optional[Dict[str, Any]] = Field(None, description="Data source parameters")
...
class BacktestResponse(BaseModel):
    ...
    instruments: List[str] = Field(..., description="Instruments used in the backtest")
    ...
    drawdowns: List[Dict[str, Any]] = Field(..., description="List of drawdowns")
...
router = APIRouter(
    prefix="/v1/analysis/backtesting",
    tags=["Backtesting"]
)
...
@router.post(
    ...
    description="Run a backtest for a trading strategy with the specified configuration."
)
async def run_backtest(
    ...
    try:
        # Convert request to BacktestConfiguration
        ...
        # Run backtest
        result = await backtesting_service.run_backtest(config, correlation_id=correlation_id)
...
@router.get(
    ...
    description="Get the results of a previously run backtest."
)
async def get_backtest_results(
    ...
    try:
        ...
        logger.info(
            f"Retrieved backtest results for {backtest_id}",
            extra={
                "correlation_id": correlation_id,
        ...
        # Raise standardized error
        raise BacktestingError(
            message=f"Error retrieving backtest results: {str(e)}",
            correlation_id=correlation_id
        )
...
@router.post(
    ...
    description="Run walk-forward optimization for a trading strategy."
)
async def run_walk_forward_optimization(
    ...
    try:
        # Convert request to WalkForwardOptimizationConfig
        ...
        result = await backtesting_service.run_walk_forward_optimization(config, correlation_id=correlation_id)
        ...
        # Raise standardized error
        raise BacktestingError(
            message=f"Error running walk-forward optimization: {str(e)}",
            correlation_id=correlation_id
        )
...
@router.post(
    ...
    description="Run Monte Carlo simulation for a previously executed backtest."
)
async def run_monte_carlo_simulation(
    ...
    try:
        # Convert request to MonteCarloSimulationConfig
        ...
        result = await backtesting_service.run_monte_carlo_simulation(config, correlation_id=correlation_id)
        ...
        # Raise standardized error
        raise BacktestingError(
            message=f"Error running Monte Carlo simulation: {str(e)}",
            correlation_id=correlation_id
        )
...
@router.post(
    ...
    description="Run stress test for a previously executed backtest."
)
async def run_stress_test(
    ...
    try:
        # Convert request to StressTestConfig
        ...
        # Run stress test
        result = await backtesting_service.run_stress_test(config, correlation_id=correlation_id)

        # Log successful stress test
        logger.info(
            f"Stress test completed for backtest {request.backtest_id}",
            extra={
                "correlation_id": correlation_id,
                "backtest_id": request.backtest_id,
...
@router.get(
    ...
    description="Get a list of available strategies for backtesting."
)
async def get_available_strategies(
    ...
    try:
        ...
        # Log successful retrieval
        logger.info(
            f"Retrieved {len(strategies)} available strategies",
            extra={
                "correlation_id": correlation_id,
        ...
        # Raise standardized error
        raise BacktestingError(
            message=f"Error retrieving available strategies: {str(e)}",
            correlation_id=correlation_id
        )
...
@router.get(
    ...
    description="Get a list of available data sources for backtesting."
)
async def get_available_data_sources(
    ...
    try:
        ...
        # Log successful retrieval
        logger.info(
            f"Retrieved {len(data_sources)} available data sources",
            extra={
                "correlation_id": correlation_id,
        ...
        # Raise standardized error
        raise BacktestingError(
            message=f"Error retrieving available data sources: {str(e)}",
            correlation_id=correlation_id
        )
...
async def legacy_run_backtest(
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/run")
    return await run_backtest(request, request_obj, backtesting_service)

@legacy_router.get("/{backtest_id}")
async def legacy_get_backtest_results(
    backtest_id: str,
    request_obj: Request = None,
    include_trades: bool = Query(True, description="Include trade details in response"),
    include_equity_curve: bool = Query(True, description="Include equity curve in response"),
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/{backtest_id}")
    return await get_backtest_results(backtest_id, request_obj, include_trades, include_equity_curve, backtesting_service)

@legacy_router.post("/walk-forward")
async def legacy_run_walk_forward_optimization(
    request: WalkForwardRequest,
    request_obj: Request = None,
    backtesting_service: BacktestingService = Depends(get_backtesting_service)
):
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/walk-forward")
    return await run_walk_forward_optimization(request, request_obj, backtesting_service)

@legacy_router.post("/monte-carlo")
async def legacy_run_monte_carlo_simulation(
    request: MonteCarloRequest,
    request_obj: Request = None,
    backtesting_service: BacktestingService = Depends(get_backtesting_service)
):
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/monte-carlo")
    return await run_monte_carlo_simulation(request, request_obj, backtesting_service)

@legacy_router.post("/stress-test")
async def legacy_run_stress_test(
    request: StressTestRequest,
    request_obj: Request = None,
    backtesting_service: BacktestingService = Depends(get_backtesting_service)
):
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/stress-test")
    return await run_stress_test(request, request_obj, backtesting_service)

@legacy_router.get("/strategies")
async def legacy_get_available_strategies(
    request_obj: Request = None,
    backtesting_service: BacktestingService = Depends(get_backtesting_service)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/strategies")
    return await get_available_strategies(request_obj, backtesting_service)

@legacy_router.get("/data-sources")
async def legacy_get_available_data_sources(
    request_obj: Request = None,
    backtesting_service: BacktestingService = Depends(get_backtesting_service)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /api/v1/analysis/backtesting/data-sources")
