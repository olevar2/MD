...
class ParameterAdjustmentResponse(BaseModel):
    ...
    adaptation_id: Optional[str] = Field(None, description="Unique ID for this adaptation instance")
...
class StrategyOutcomeRequest(BaseModel):
    ...
    feedback_content: Optional[Dict[str, Any]] = Field(default=None, description="Additional qualitative or quantitative feedback")
...
router = APIRouter(
    prefix="/v1/analysis/adaptations",
    tags=["Adaptive Layer"]
)
...
@router.post(
    "/parameters/generate",
    response_model=Dict,
    summary="Generate adaptive parameters",
    description="Generate adaptive parameters based on current market conditions and tool effectiveness."
)
async def generate_adaptive_parameters(
    request: GenerateAdaptiveParamsRequest,
    adaptive_layer: AdaptiveLayer = Depends(get_adaptive_layer)
):
    """
...
@router.post(
    ...
    summary="Adjust strategy parameters",
    description="Adjust strategy parameters based on market conditions and tool effectiveness."
)
...
@router.post(
    ...
    description="Generate adaptive parameters and apply them to the strategy execution engine."
)
async def update_strategy_parameters(
    request: UpdateStrategyParamsRequest,
    integration_service: AdaptiveLayerIntegrationService = Depends(get_adaptive_integration_service)
):
    """
...
@router.post(
    ...
    response_model=Dict,
    summary="Generate strategy recommendations",
    description="Generate recommendations for optimizing a strategy based on effectiveness data."
)
async def generate_strategy_recommendations(
    request: GenerateStrategyRecommendationsRequest,
    optimizer: AdaptiveStrategyOptimizer = Depends(get_adaptive_strategy_optimizer)
):
    """
...
@router.post(
    ...
    response_model=Dict,
    summary="Analyze strategy effectiveness trend",
    description="Analyze how a strategy's effectiveness has changed over time."
)
...
@router.post(
    "/feedback/outcomes",
    status_code=202,
    summary="Record strategy outcome",
    description="Record the outcome of a strategy execution with adapted parameters."
)
async def record_strategy_outcome(
    ...
    try:
        ...
        logger.error(f"Failed to record strategy outcome: {str(e)}", exc_info=True)
...
@router.get(
    ...
    description="Get the history of adaptation decisions from the adaptation engine."
)
async def get_adaptation_history(
    ...
    try:
        ...
        logger.error(f"Failed to retrieve adaptation history: {str(e)}", exc_info=True)
        raise HTTPException(status_code=500, detail=f"Failed to retrieve adaptation history: {str(e)}")


@router.get(
    "/parameters/history/{strategy-id}/{instrument}/{timeframe}",
    response_model=ParameterHistoryResponse,
    summary="Get parameter history",
    description="Get parameter adjustment history for a specific strategy, instrument, and timeframe."
)
async def get_parameter_history(
    strategy_id: str = Path(..., description="Identifier for the strategy", alias="strategy-id"),
    ...
    try:
        ...
        logger.error(f"Failed to retrieve parameter history: {str(e)}", exc_info=True)
        raise HTTPException(status_code=500, detail=f"Failed to retrieve parameter history: {str(e)}")


@router.get(
    "/feedback/insights/{strategy-id}",
    response_model=AdaptationInsightResponse,
    summary="Get adaptation insights",
...
@router.get(
    "/feedback/performance/{strategy-id}",
    response_model=AdaptationPerformanceResponse,
    summary="Get performance by regime",
    description="Get aggregated performance metrics by market regime for a specific strategy."
)
...
legacy_router = APIRouter(
    prefix="/api/v1/adaptive-layer",
    tags=["Adaptive Layer (Legacy)"]
)
...
async def legacy_generate_adaptive_parameters(
    request: GenerateAdaptiveParamsRequest,
    adaptive_layer: AdaptiveLayer = Depends(get_adaptive_layer)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/parameters/generate")
    return await generate_adaptive_parameters(request, adaptive_layer)

@legacy_router.post("/parameters/adjust", response_model=ParameterAdjustmentResponse)
async def legacy_adjust_parameters(
    request: ParameterAdjustmentRequest,
    service: ParameterAdjustmentService = Depends(get_parameter_adjustment_service)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/parameters/adjust")
    return await adjust_parameters(request, service)

@legacy_router.post("/strategy/update", response_model=Dict)
async def legacy_update_strategy_parameters(
    request: UpdateStrategyParamsRequest,
    integration_service: AdaptiveLayerIntegrationService = Depends(get_adaptive_integration_service)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/strategy/update")
...
async def legacy_generate_strategy_recommendations(
    request: GenerateStrategyRecommendationsRequest,
    optimizer: AdaptiveStrategyOptimizer = Depends(get_adaptive_strategy_optimizer)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/strategy/recommendations")
...
async def legacy_analyze_strategy_effectiveness_trend(
    request: AnalyzeStrategyEffectivenessRequest,
    optimizer: AdaptiveStrategyOptimizer = Depends(get_adaptive_strategy_optimizer)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/strategy/effectiveness-trend")
    return await analyze_strategy_effectiveness_trend(request, optimizer)

@legacy_router.post("/feedback/outcomes", status_code=202)
async def legacy_record_strategy_outcome(
    request: StrategyOutcomeRequest,
    feedback_loop: FeedbackLoop = Depends(get_feedback_loop)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/feedback/outcomes")
    return await record_strategy_outcome(request, feedback_loop)

@legacy_router.get("/adaptations/history", response_model=AdaptationHistoryResponse)
async def legacy_get_adaptation_history(
    adaptation_engine: AdaptationEngine = Depends(get_adaptation_engine)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/adaptations/history")
    return await get_adaptation_history(adaptation_engine)

@legacy_router.get("/parameters/history/{strategy_id}/{instrument}/{timeframe}", response_model=ParameterHistoryResponse)
async def legacy_get_parameter_history(
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/parameters/history/{strategy-id}/{instrument}/{timeframe}")
    return await get_parameter_history(strategy_id, instrument, timeframe, limit, service)

@legacy_router.get("/feedback/insights/{strategy_id}", response_model=AdaptationInsightResponse)
async def legacy_get_adaptation_insights(
    strategy_id: str = Path(..., description="Identifier for the strategy"),
    feedback_loop: FeedbackLoop = Depends(get_feedback_loop)
):
    """
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/feedback/insights/{strategy-id}")
    return await get_adaptation_insights(strategy_id, feedback_loop)

@legacy_router.get("/feedback/performance/{strategy_id}", response_model=AdaptationPerformanceResponse)
async def legacy_get_performance_by_regime(
    strategy_id: str = Path(..., description="Identifier for the strategy"),
    market_regime: Optional[str] = Query(None, description="Optional filter for a specific market regime"),
    feedback_loop: FeedbackLoop = Depends(get_feedback_loop)
):
    ...
    """
    logger.info("Legacy endpoint called - consider migrating to /v1/analysis/adaptations/feedback/performance/{strategy-id}")
    return await get_performance_by_regime(strategy_id, market_regime, feedback_loop)
