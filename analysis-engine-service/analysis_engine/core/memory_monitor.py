...
MEMORY_WARNING = Counter(
    'memory_warning_total',
...
class MemoryMonitor:
    ...
    def __init__(self):
        ...
        self._warning_threshold = 0.8  # 80% of available memory
        self._critical_threshold = 0.9  # 90% of available memory
    ...
    async def _check_memory_usage(self) -> None:
        ...
        try:
            ...
            if memory_percent >= self._critical_threshold:
                ...
                logger.critical(
                    f"Critical memory usage: {memory_percent:.1%} "
                    f"({system_memory.used / 1024 / 1024:.0f}MB used)"
                )
