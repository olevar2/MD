...
class TimeseriesAggregator:
    ...
    def aggregate(
        self,
        data: List[OHLCVData],
        source_timeframe: TimeframeEnum,
        target_timeframe: TimeframeEnum,
        method: AggregationMethodEnum = AggregationMethodEnum.OHLCV
    ) -> List[OHLCVData]:
        ...
        if method == AggregationMethodEnum.OHLCV:
            result_df = self._standard_ohlcv_aggregation(df, target_timeframe.value)
    ...
    def _vwap_aggregation(self, df: pd.DataFrame, 
                     target_timeframe: str) -> pd.DataFrame:
    ...
    def _twap_aggregation(self, df: pd.DataFrame, 
                     target_timeframe: str) -> pd.DataFrame:
