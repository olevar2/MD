...
from data_pipeline_service.exceptions.validation_exceptions import ValidationError # Corrected import
...
from ...validation.ohlcv_validators import (
    validate_instrument_format, 
    validate_timeframe, 
    validate_date_range, 
    is_valid_timeframe_conversion
)
...
@router.get("/historical/{instrument}/ohlcv", response_model=OHLCVResponse, tags=["Historical Data"])
async def get_historical_ohlcv(
    instrument: str = Path(..., description="Trading instrument identifier (e.g., EUR_USD)"),
...
@router.get("/historical/{instrument}/aggregated", response_model=OHLCVResponse, tags=["Data Aggregation"])
