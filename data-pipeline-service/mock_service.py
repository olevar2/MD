...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/market-data', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/data-sources', 'expected_status': 200}]:
...
print(f"Starting mock service for data-pipeline-service on port {PORT}")
