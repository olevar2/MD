#!/usr/bin/env python3
"""
Start script for the Data Pipeline Service.
"""
...
def start_service():
    ...
    try:
        ...
        print("Data Pipeline Service is running on port 8004")
        print("Health endpoint: http://localhost:8004/health")
        print("API endpoints:")
        print("  - GET /api/v1/market-data")
        print("  - GET /api/v1/data-sources")
