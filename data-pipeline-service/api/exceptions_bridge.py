...
3. Replace DataPipelineError with your service-specific error class
...
# Service name
SERVICE_NAME = "data-pipeline"  # Replace with your service name


# Service-specific error class
class DataPipelineError(ServiceError):
...
class DataPipelineValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class DataPipelineDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class DataPipelineBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = DataPipelineError,
...
__all__ = [
    ...
    "DataPipelineDataError",
    "DataPipelineBusinessError",
