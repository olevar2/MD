...
3. Replace MLWorkbenchError with your service-specific error class
...
# Service name
SERVICE_NAME = "ml-workbench"  # Replace with your service name


# Service-specific error class
class MLWorkbenchError(ServiceError):
...
class MLWorkbenchValidationError(ValidationError):
    """Exception for service-specific validation errors."""
    pass


class MLWorkbenchDataError(DataError):
    """Exception for service-specific data errors."""
    pass


class MLWorkbenchBusinessError(BusinessError):
...
def with_exception_handling(
    ...
    *,
    error_class: Type[BaseError] = MLWorkbenchError,
...
__all__ = [
    ...
    "MLWorkbenchError",
    "MLWorkbenchValidationError",
    "MLWorkbenchDataError",
    "MLWorkbenchBusinessError",
