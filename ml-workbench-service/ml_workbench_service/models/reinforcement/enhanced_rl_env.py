...
from trading_gateway_service.simulation.forex_broker_simulator import (
    ForexBrokerSimulator, OrderSide, OrderType, Order, MarketRegimeType
)
...
from risk_management_service.models.risk_metrics import calculate_sharpe_ratio, calculate_sortino_ratio, calculate_max_drawdown
...
class EnhancedForexTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        news_sentiment_simulator: Optional[NewsAndSentimentSimulator] = None,  # News simulator
