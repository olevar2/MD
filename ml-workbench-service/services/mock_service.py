...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    """
        ...
        # API endpoints
        for endpoint_config in [{'method': 'GET', 'endpoint': '/api/v1/experiments', 'expected_status': 200}, {'method': 'GET', 'endpoint': '/api/v1/model-registry', 'expected_status': 200}]:
...
print(f"Starting mock service for ml-workbench-service on port {PORT}")
